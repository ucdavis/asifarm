...
function GenerateProjectColumn(val /* entry value from spreadsheet */){
    var project1title = "<span style='font-size: 0.8em;'>" + val.gsx$project1title.$t.trunc(100) + "</span>";
    var project1details = "Project Completed: " + val.gsx$expectedcompletiondate.$t;
    ...
    var project2title = "<span style='font-size: 0.8em;'>" + val.gsx$project2title.$t.trunc(100) + "</span>";
    var project2details = "Project Completed: " + val.gsx$expectedcompletiondate_2.$t;
    ...
    var project3title = "<span style='font-size: 0.8em;'>" + val.gsx$project3title.$t.trunc(100) + "</span>";
    var project3details = "Project Completed: " + val.gsx$expectedcompletiondate_3.$t;
